module.exports = {
	...
	// Attribute to anonymize before publish message, accepts json path syntax
	// https://github.com/dchester/jsonpath#jsonpath-syntax
	anonymizeAttributes: (process.env.ANONYMIZE_ATTRS || "$..password,$..newPassword,$..confirmPassword,$.data.headers.authorization").split(",")
};
